...
public class DividendServiceImpl implements DividendService {
    ...
    public List<DividendDTO> findCalendar(DividendForm dividendForm) {
        ...
        dividendDTOList.addAll(convertToDividendDTOList(dividendList, krStockJpaRepository, true));
        ...
        dividendDTOList.addAll(convertToDividendDTOList(dividendList, krStockJpaRepository, false));
    ...
    <T extends Stock> List<DividendDTO> convertToDividendDTOList(List<Dividend> dividendList, JpaRepository<T, Integer> stockJpaRepository, boolean isFixed) {
        List<DividendDTO> dividendDTOList = new ArrayList<>();
